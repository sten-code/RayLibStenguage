...
namespace RayLibStenguage
{
    public class RCore
    {
        ...
        public static RuntimeResult CompressData(Context ctx,
            StringValue data, NumberValue dataSize, NumberValue compDataSize)
        {
            return new RuntimeResult().Success(new StringValue(Imports.CompressData(data.Value, (int)dataSize.Value, (int)compDataSize.Value)));
        }
        ...
        public static RuntimeResult DecompressData(Context ctx,
            StringValue compData, NumberValue compDataSize, NumberValue dataSize)
        {
            return new RuntimeResult().Success(new StringValue(Imports.DecompressData(compData.Value, (int)compDataSize.Value, (int)dataSize.Value)));
        }
        ...
        public static RuntimeResult EncodeDataBase64(Context ctx,
            StringValue data, NumberValue dataSize, NumberValue outputSize)
        {
            return new RuntimeResult().Success(new StringValue(Imports.EncodeDataBase64(data.Value, (int)dataSize.Value, (int)outputSize.Value)));
        }
        ...
        public static RuntimeResult DecodeDataBase64(Context ctx,
            StringValue data, NumberValue outputSize)
        {
            return new RuntimeResult().Success(new StringValue(Imports.DecodeDataBase64(data.Value, (int)outputSize.Value)));
        }
